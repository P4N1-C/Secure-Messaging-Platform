...
export function ChatPane({
  ...
  return (
    <>
      <header 
        className="h-16 flex items-center px-4 border-b border-gray-200 dark:border-gray-800 shrink-0 bg-white dark:bg-gray-900 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
        onClick={onOpenInfo}
      >
        <button 
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col bg-white dark:bg-gray-900">
        <ChatHeaderCard
